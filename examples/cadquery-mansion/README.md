...
This project is a representative building workload for CadQuery, live display, quantities, history and drawings. It is an architectural framing study with 14 room bays on each of two storeys, three connected wings and 509.9 m² of floor platforms. Default evaluation registers 6,630 physical parts and checks 11,334 native geometric requirements.
